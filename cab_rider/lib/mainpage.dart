...
import 'package:cab_rider/syles/styles.dart';
import 'package:cab_rider/widget/BrandDivider.dart';
import 'package:cab_rider/widget/CollectPaymentDialog.dart';
import 'package:cab_rider/widget/NoDriverDialog.dart';
import 'package:cab_rider/widget/ProgressDialog.dart';
import 'package:cab_rider/widget/TaxiButton.dart';
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        Column(
                          ...
                          children: <Widget>[
                            Text('Iacov Robert', style: TextStyle(fontSize: 20, fontFamily: 'Brand-Bold'),),
                            SizedBox(height: 5,),
                            Text('View Profile'),
                          ],
                        )
